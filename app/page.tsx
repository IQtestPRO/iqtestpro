...
import { ChevronRight, Brain, Crown, Lock, Award, Cpu, Sparkles } from "lucide-react"
      ...
      <div className="container relative mx-auto max-w-screen-xl px-4 py-24 md:py-36 text-center z-10">
        ...
        <div className="mb-12 flex flex-col items-center space-y-8">
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl group-hover:shadow-cyan-500/25 transition-all duration-500">
              <div className="flex items-center justify-center w-32 h-32 mx-auto mb-6">
                <div className="relative">
                  ...
                  <div className="relative flex items-center justify-center w-full h-full bg-gradient-to-br from-cyan-500 to-blue-700 rounded-2xl shadow-2xl">
              ...
              {/* IQ Test Pro Branding */}
              <div className="text-center">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-4 bg-gradient-to-r from-white via-cyan-200 to-blue-200 bg-clip-text text-transparent tracking-tight">
                  IQ Test Pro
                </h1>
                <div className="flex items-center justify-center space-x-2 mb-6">
                  <div className="h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent flex-1 max-w-20"></div>
                  <Badge className="bg-gradient-to-r from-emerald-500/20 to-cyan-500/20 text-emerald-300 border-emerald-400/30 px-4 py-1">
                    Certificação Científica
                  </Badge>
                  <div className="h-px bg-gradient-to-r from-transparent via-cyan-400 to-transparent flex-1 max-w-20"></div>
                </div>
                <p className="text-xl md:text-2xl text-blue-100 font-medium">Avaliação Cognitiva Profissional</p>
              </div>
            </div>
          </div>

          {/* Pricing Badge */}
          <div className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-amber-500/20 to-orange-500/20 rounded-full border border-amber-400/30 backdrop-blur-sm">
            <Lock className="w-5 h-5 text-amber-400" />
            <span className="text-sm font-semibold text-amber-200 font-inter">Planos Premium a partir de R$ 9,90</span>
          </div>
        </div>
        <p
          className="text-lg md:text-xl text-blue-100 max-w-2xl mx-auto mb-8 sm:mb-12 leading-relaxed animate-fade-in-up font-inter text-center"
          style={{ animationDelay: "0.2s" }}
        >
          Descubra seu potencial intelectual com precisão científica.
          <span className="text-cyan-300 font-semibold"> Resultados confiáveis em 15 minutos.</span>
        </p>
