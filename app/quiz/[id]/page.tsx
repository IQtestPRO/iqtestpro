...
const MISSION_QUESTIONS: Record<number, QuizQuestion[]> = {
  1: [
    ...
    // Adicionar mais questões até completar 15
    ...Array.from({ length: 10 }, (_, i) => ({
      id: `spatial_${String(i + 6).padStart(3, "0")}`,
      type: "multiple-choice" as const,
      category: "Padrões Espaciais",
      question: `Questão de padrão espacial ${i + 6}: Complete a sequência lógica apresentada.`,
      options: ["Opção A", "Opção B", "Opção C", "Opção D"],
      correctAnswer: Math.floor(Math.random() * 4),
      timeLimit: 60,
      difficulty: (Math.floor(i / 3) + 1) as 1 | 2 | 3 | 4 | 5,
      explanation: `Esta questão testa sua capacidade de reconhecer padrões espaciais complexos.`,
      points: 10 + Math.floor(i / 3) * 5,
    })),
  ],
  2: [
    {
    ...
    // Adicionar mais questões até completar 20
    ...Array.from({ length: 18 }, (_, i) => ({
      id: `logical_${String(i + 3).padStart(3, "0")}`,
      type: "multiple-choice" as const,
      category: "Raciocínio Lógico",
      question: `Questão lógica ${i + 3}: Resolva o problema de raciocínio apresentado.`,
      options: ["Opção A", "Opção B", "Opção C", "Opção D"],
      correctAnswer: Math.floor(Math.random() * 4),
      timeLimit: 75,
      difficulty: (Math.floor(i / 4) + 2) as 1 | 2 | 3 | 4 | 5,
      explanation: `Esta questão avalia seu raciocínio dedutivo e capacidade de análise lógica.`,
      points: 15 + Math.floor(i / 4) * 5,
    })),
  ],
  3: [
    {
    ...
    // Adicionar mais questões até completar 25
    ...Array.from({ length: 24 }, (_, i) => ({
      id: `abstract_${String(i + 2).padStart(3, "0")}`,
      type: "multiple-choice" as const,
      category: "Raciocínio Abstrato",
      question: `Questão abstrata ${i + 2}: Identifique o padrão abstrato complexo.`,
      options: ["Opção A", "Opção B", "Opção C", "Opção D"],
      correctAnswer: Math.floor(Math.random() * 4),
      timeLimit: 120,
      difficulty: (Math.floor(i / 5) + 3) as 1 | 2 | 3 | 4 | 5,
      explanation: `Esta questão mede sua inteligência fluida e capacidade de raciocínio abstrato.`,
      points: 20 + Math.floor(i / 5) * 5,
    })),
  ],
  4: [
    {
    ...
    // Adicionar mais questões até completar 50
    ...Array.from({ length: 49 }, (_, i) => ({
      id: `expert_${String(i + 2).padStart(3, "0")}`,
      type: "multiple-choice" as const,
      category: "Avaliação Completa",
      question: `Questão expert ${i + 2}: Resolva este desafio multidisciplinar avançado.`,
      options: ["Opção A", "Opção B", "Opção C", "Opção D"],
      correctAnswer: Math.floor(Math.random() * 4),
      timeLimit: 90,
      difficulty: (Math.floor(i / 10) + 3) as 1 | 2 | 3 | 4 | 5,
      explanation: `Esta questão combina múltiplas áreas da inteligência em um desafio integrado.`,
      points: 25 + Math.floor(i / 10) * 5,
    })),
  ],
}
